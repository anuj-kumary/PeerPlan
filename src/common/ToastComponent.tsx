export const ToastComponent = ({ errorType, message }: { errorType: string, message: string }) => {

    const getToastDetails = () => {
        switch (errorType) {
            case "success":
                return (
                    <div className="bg-white shadow-[0_3px_10px_-3px_rgba(6,81,237,0.3)] border-l-[6px] border-green-500 text-gray-800 flex items-center w-max max-w-sm p-4 rounded-md"
                        role="alert">
            ...
            case "warning":
                return (<div className="bg-white shadow-[0_3px_10px_-3px_rgba(6,81,237,0.3)] border-l-[6px] border-yellow-500 text-gray-800 flex items-center w-max max-w-sm p-4 rounded-md"
                    role="alert">
            ...
            case "error":
                return (
                    <div className="bg-white shadow-[0_3px_10px_-3px_rgba(6,81,237,0.3)] border-l-[6px] border-red-500 text-gray-800 flex items-center w-max max-w-sm p-4 rounded-md"
                        role="alert">
    ...
    const toastDetails = getToastDetails();

    if (!toastDetails) return null;

    return (
        <div className="space-y-6 mx-auto w-max mt-4">
            {toastDetails}
        </div>
    );
};
