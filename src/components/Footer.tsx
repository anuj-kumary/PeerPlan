            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul className="space-y-4">
                        <li>
                            <a className="text-gray-300 hover:text-white text-sm">Email</a>
                        </li>
                        <li>
                            <a className="text-gray-300 hover:text-white text-sm">Phone</a>
                        </li>
                        <li>
                            <a className="text-gray-300 hover:text-white text-sm">Address</a>
                        </li>
                    </ul>
                </div>
